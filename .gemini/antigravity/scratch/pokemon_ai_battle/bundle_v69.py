...
output_name = 'submission_v69.zip'
output_path = os.path.join(project_dir, output_name)

with zipfile.ZipFile(output_path, 'w', zipfile.ZIP_DEFLATED) as zipf:
    zipf.write(os.path.join(project_dir, 'v69_agent', 'main.py'), 'main.py')
    print("Added: main.py")
...
shutil.copy2(output_path, r'C:\Users\admin\Downloads\submission_v69.zip')
