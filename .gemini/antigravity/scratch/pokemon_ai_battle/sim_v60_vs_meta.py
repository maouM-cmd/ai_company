"""V60 vs 6 meta decks — win rate measurement (20 games each)"""
...
v60 = load("v60", os.path.join(BASE, "v60_agent/main.py"))
...
print("=== V60 (エースバーン水) vs meta (N=20 each) ===")
